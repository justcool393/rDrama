...
def stats(site=None):
	...
	import timeit
	print(timeit.timeit(lambda:str(time.strftime("%d/%B/%Y %H:%M:%S UTC", time.gmtime(now), repetitions=1))))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Marsey).filter(Marsey.submitter_id==None).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).filter_by(is_private=True).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).filter(User.is_banned > 0).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).filter_by(is_activated=True).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(func.sum(User.coins)).scalar(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(func.sum(User.coins_spent)).scalar(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).filter(User.created_utc > day).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission.author_id).distinct().count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).filter_by(is_banned=False).filter(Submission.deleted_utc == 0).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).filter_by(is_banned=True).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).filter_by(is_banned=True).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).filter(Submission.created_utc > day).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment).filter(Comment.author_id != AUTOJANNY_ID).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment.author_id).distinct().count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment).filter_by(is_banned=True).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment).filter(Comment.deleted_utc > 0).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment).filter(Comment.created_utc > day, Comment.author_id != AUTOJANNY_ID).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Vote).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(CommentVote).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Vote).filter_by(vote_type=1).count() + g.db.query(CommentVote).filter_by(vote_type=1).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Vote).filter_by(vote_type=-1).count() + g.db.query(CommentVote).filter_by(vote_type=-1).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(AwardRelationship).count()),))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(AwardRelationship).filter(or_(AwardRelationship.submission_id != None, AwardRelationship.comment_id != None)).count(), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(len(active_users), repetitions=1)))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).filter(User.last_active > week).count(), repetitions=1)))
