...
def stats(site=None):
	...
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Marsey).filter(Marsey.submitter_id==None).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).filter_by(is_private=True).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).filter(User.is_banned > 0).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).filter_by(is_activated=True).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(func.sum(User.coins)).scalar()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(func.sum(User.coins_spent)).scalar()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(User).filter(User.created_utc > day).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission.author_id).distinct().count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).filter_by(is_banned=False).filter(Submission.deleted_utc == 0).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).filter_by(is_banned=True).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).filter_by(is_banned=True).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Submission).filter(Submission.created_utc > day).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment).filter(Comment.author_id != AUTOJANNY_ID).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment.author_id).distinct().count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment).filter_by(is_banned=True).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment).filter(Comment.deleted_utc > 0).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Comment).filter(Comment.created_utc > day, Comment.author_id != AUTOJANNY_ID).count()), number=1))
	print(timeit.timeit(lambda:"{:,}".format(g.db.query(Vote).count()), number=1))
